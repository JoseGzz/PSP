...
public class Files implements Comparable<Files> {
	...
	public static int iTotalEmpty = 0; // suma de lineas vacias
	public static int iTotalInfo = 0; // suma de lineas con informacion

	private BufferedReader brBuffer; // variable para leer lineas
	private int iEmptyLines = 0; // cantidad de lineas vacias
	private int iInfoLines = 0; // cantidad de lineas con informacion
