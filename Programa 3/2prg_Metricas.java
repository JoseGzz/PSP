...
public class Metricas {
	...
	public static void main(String[] args) {
		...
		// se crea un objeto de tipo calculadora para realizar todos los cálculos
		Calculadora calc = new Calculadora(orgOrganizador.iX, orgOrganizador.iY, arrLineas.size() - 1, orgOrganizador.getXk());
		...
		dB1 = calc.getB1();
		dYk = calc.getYk();		
		// se establece un formato de impresión para números de los cuales no se sabe si serán enteros o de punto flotante
		DecimalFormat df = new DecimalFormat("#.#####");
		df.setRoundingMode(RoundingMode.CEILING);

		// se imrpimen los resultados
		System.out.println("N  = " + iN);
		System.out.println("xk = " + df.format(dXk));
	 ...
	 */
	// &i
	public static boolean buscaArchivo(String sNombre) { // &m
